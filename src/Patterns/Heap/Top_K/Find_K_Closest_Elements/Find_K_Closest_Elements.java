package Patterns.Heap.Top_K.Find_K_Closest_Elements; 
...
public class Find_K_Closest_Elements extends ProblemSolver { 
    ...
    public List<Integer> findClosestElements_UsingHeap(int[] nums, int k, int x) {
        Queue<Node> minHeap = new PriorityQueue<Node>(new HeapComparator());
    ...
    public class HeapComparator implements Comparator<Node>{
        ...
        public int compare(Node a, Node b){
            int diffComparison = Integer.compare(a.diff, b.diff);
            if(diffComparison != 0){
                return diffComparison;
            }

            int elemComparison = Integer.compare(a.elem, b.elem);
