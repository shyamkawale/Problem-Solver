package Patterns.LinkedList.General.Reverse_DLL;
...
// import Patterns.LinkedList.General.Doubly_LinkedList_Operations.Doubly_LinkedList_Operations;
...
public class Reverse_DLL extends ProblemSolver {
    ...
    public ListNode reverseList2(ListNode head) {
        ...
        while (currNode != null) {
            ...
            currNode.prev = nextNode; // only extra step compared to Singly LL
