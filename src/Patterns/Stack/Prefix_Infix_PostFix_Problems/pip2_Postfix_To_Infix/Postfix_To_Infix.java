package Patterns.Stack.Prefix_Infix_PostFix_Problems.pip2_Postfix_To_Infix;
...
public class Postfix_To_Infix extends ProblemSolver{
    public static void main(String[] args) {
        new Postfix_To_Infix().readInput();
    }
    ...
    public String postfixToInfix(String exp) {
        ...
        for(Character ch: exp.toCharArray()){
            ...
            if(getPrecedence(ch) != -1){ //when ch is operator
                ...
                String str = "(" + secLastElem + "" + ch + "" + lastElem + ")";
                stack.push(str);
            }
