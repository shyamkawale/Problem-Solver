package Patterns.Stack.Normal_Stack.ns6_Find_the_Most_Competitive_Subsequence;
...
We define that a subsequence a is more competitive than subsequence b (of the same length) if in the first position where a and b differ,
