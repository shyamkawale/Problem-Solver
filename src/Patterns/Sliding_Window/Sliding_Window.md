...
12. [Minimum Size Subarray Sum](https://leetcode.com/problems/minimum-size-subarray-sum) => only for positive numbers (#TOWRITE 📅) , prefixSum approach ??❓

#### Count all valid subarray

8. [Count Number of Nice Subarrays](https://leetcode.com/problems/count-number-of-nice-subarrays)
9. [Binary Subarrays With Sum](https://leetcode.com/problems/binary-subarrays-with-sum) , *PrefixSum also
...
1. https://leetcode.com/problems/subarray-product-less-than-k/ (with only +ve elements) => if -ve then O(n^2) only. (#TOWRITE 📅)
2. https://leetcode.com/problems/minimum-operations-to-reduce-x-to-zero/description/ => 2 ways of using sliding window. (#TOWRITE 📅)
